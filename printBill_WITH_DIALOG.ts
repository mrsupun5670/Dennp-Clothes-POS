// UPDATED printBill function with PRINT DIALOG
// Replace the printBill function in OrdersPage.tsx with this version
// This shows the print dialog instead of silent printing
...
const printBill = async (order: Order) => {
  try {
    ...
    // Wait for rendering then open print dialog
    setTimeout(() => {
      try {
        const htmlContent = `
          <!DOCTYPE html>
        ...
        // Create a new window and open print dialog
