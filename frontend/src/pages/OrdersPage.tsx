...
const OrdersPage: React.FC = () => {
  ...
  const [orders, setOrders] = useState<Order[]>([
    // Recent orders - Pending/Processing
    {
      ...
      paymentLocked: false,
      expectedPaymentDate: "2024-12-04",
      daysOverdue: 0,
      isOverdue: false,
      ...
      trackingNumber: "",
      items: [
        { productName: "Cotton Crew Neck T-Shirt", quantity: 4, price: 1250.00 },
        { productName: "Jeans Premium", quantity: 2, price: 2500.00 },
      ],
      paymentHistory: [
        {
          id: "PAY001",
    ...
    },
    {
      ...
      paymentLocked: false,
      expectedPaymentDate: "2024-12-02",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      trackingNumber: "",
      items: [
        { productName: "Casual Dress", quantity: 2, price: 3500.00 },
        { productName: "Summer Crop Top", quantity: 3, price: 950.00 },
      ],
      paymentHistory: [
        {
          id: "PAY002",
    ...
    // Shipped/Delivered orders
    {
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-12-01",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      items: [
        { productName: "Winter Jacket", quantity: 2, price: 4500.00 },
      ],
      paymentHistory: [
        {
          id: "PAY004",
    ...
    },
    {
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-30",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      items: [
        { productName: "Cotton Polo Shirt", quantity: 4, price: 1600.00 },
      ],
      paymentHistory: [
        {
          id: "PAY006",
    ...
    },
    {
      id: "ORD005",
      customerId: "C004",
      customerName: "Priya Jayasooriya",
      customerMobile: "+94-77-1234567",
      customerAddress: "100 Mount Lavinia Road, Colombo",
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-29",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      items: [
        { productName: "Cargo Pants", quantity: 2, price: 2200.00 },
        { productName: "Formal Shirt", quantity: 1, price: 1800.00 },
      ],
      paymentHistory: [
        {
          id: "PAY008",
    ...
    // More recent orders
    {
      id: "ORD006",
      customerId: "C005",
      customerName: "Lakshmi Fernando",
      customerMobile: "+94-71-9876543",
      customerAddress: "200 Galle Face Green, Colombo",
    ...
    },
    {
      ...
      customerMobile: "+92-300-1111111",
      customerAddress: "321 Defence Road, Karachi",
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-27",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      items: [
        { productName: "Cotton Polo Shirt", quantity: 3, price: 1600.00 },
      ],
      paymentHistory: [
        {
          id: "PAY011",
    ...
    },
    {
      ...
      customerMobile: "+92-300-2222222",
      customerAddress: "654 Clifton Road, Karachi",
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-26",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      reminderCount: 0,
      status: "delivered",
      trackingNumber: "TRK678901234",
      items: [
        { productName: "Summer Crop Top", quantity: 5, price: 950.00 },
      ],
      paymentHistory: [
        {
          id: "PAY013",
    ...
    },
    {
      ...
      customerMobile: "+92-300-3333333",
      customerAddress: "987 Garden East, Lahore",
      ...
      trackingNumber: "",
      items: [
        { productName: "Jeans Premium", quantity: 3, price: 2500.00 },
      ],
      paymentHistory: [
        {
          id: "PAY015",
    ...
    },
    {
      ...
      customerMobile: "+92-300-4444444",
      customerAddress: "147 Mall Road, Islamabad",
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-24",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
    ...
    },
    {
      ...
      customerMobile: "+92-300-5555555",
      customerAddress: "258 Canal Road, Lahore",
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-23",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      items: [
        { productName: "Cotton Crew Neck T-Shirt", quantity: 6, price: 1250.00 },
      ],
      paymentHistory: [
        {
          id: "PAY018",
    ...
    },
    {
      ...
      daysOverdue: 2,
      isOverdue: true,
      lastReminderSentDate: "2024-11-18",
      reminderStatus: "sent",
      reminderCount: 1,
      status: "pending",
      trackingNumber: "",
      items: [
        { productName: "Formal Shirt", quantity: 3, price: 1800.00 },
      ],
      paymentHistory: [
        {
          id: "PAY020",
    ...
    },
    {
      ...
      customerMobile: "+92-300-6666666",
      customerAddress: "369 Sheikhupura Road, Lahore",
      ...
      paymentStatus: "fully_paid",
      paymentLocked: true,
      expectedPaymentDate: "2024-11-21",
      daysOverdue: 0,
      isOverdue: false,
      lastReminderSentDate: undefined,
      reminderStatus: "not_sent",
      ...
      items: [
        { productName: "Casual Dress", quantity: 1, price: 3500.00 },
        { productName: "Cotton Polo Shirt", quantity: 1, price: 1600.00 },
      ],
      paymentHistory: [
        {
          id: "PAY021",
    ...
    },
    {
      ...
      customerMobile: "+92-300-7777777",
      customerAddress: "741 Iqbal Park, Faisalabad",
      ...
      items: [
        { productName: "Cargo Pants", quantity: 2, price: 2200.00 },
        { productName: "Cotton Crew Neck T-Shirt", quantity: 1, price: 1250.00 },
      ],
      paymentHistory: [
        {
          id: "PAY023",
    ...
    },
    {
      ...
      customerMobile: "+92-300-8888888",
      customerAddress: "852 Race Course Road, Rawalpindi",
      ...
      daysOverdue: 2,
      isOverdue: true,
      lastReminderSentDate: "2024-11-17",
      reminderStatus: "sent",
      reminderCount: 1,
      status: "pending",
      trackingNumber: "",
      items: [
        { productName: "Summer Crop Top", quantity: 2, price: 950.00 },
      ],
      paymentHistory: [
        {
          id: "PAY024",
