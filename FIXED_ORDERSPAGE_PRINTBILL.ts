...
// CHANGES:
// 1. Uses order.items (already loaded) instead of fetching
// 2. Creates rotated temp file for printing
// 3. Silent print using mspaint /pt
// 4. Auto-deletes temp file
// 5. No browser print dialog
