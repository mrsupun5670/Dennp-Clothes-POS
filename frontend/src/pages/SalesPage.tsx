        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6 flex flex-col min-h-0">
          ...
          {cartItems.length > 0 && (
            <div className="mb-4 bg-gray-900/50 rounded-lg overflow-hidden">
              <div className="grid grid-cols-12 gap-2 px-3 py-2 bg-gray-900 border-b border-gray-700 text-xs font-semibold text-gray-300">
              ...
              <div className="divide-y divide-gray-700/50">
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="grid grid-cols-12 gap-2 px-3 py-2 text-xs hover:bg-gray-800/30 transition-colors"
                  >
                    ...
                    <div className="col-span-2 text-right font-medium text-red-400">
