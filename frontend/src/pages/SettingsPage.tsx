        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="number" defaultValue="10" className="mt-1 w-full px-4 py-2 bg-gray-700 border border-red-600/30 text-white placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500" />
            </div>
          </div>
        </div>
